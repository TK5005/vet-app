...
ALTER TABLE HEALTH_RECORD ADD CONSTRAINT FOREIGN KEY (petID) REFERENCES PET (petID);
ALTER TABLE HEALTH_RECORD ADD CONSTRAINT FOREIGN KEY (examID) REFERENCES EXAMINATION (examID);
